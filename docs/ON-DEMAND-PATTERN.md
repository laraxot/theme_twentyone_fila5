---
title: "On-Demand Pattern — Theme TwentyOne"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
# On-Demand Pattern — Theme **TwentyOne**
...
| Ricerca locale | `qmd search "topic" -c twentyone` |
| Wiki locale | `Read ./laravel/Themes/TwentyOne/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Themes/TwentyOne/docs/wiki/log.md
