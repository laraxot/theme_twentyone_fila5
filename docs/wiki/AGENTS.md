# TwentyOne {{TYPE^}} LLM Wiki Agent Instructions

> **Module/Theme:** TwentyOne
> **Scope:** TwentyOne-specific knowledge only
> **Created:** 2026-04-15
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **TwentyOne Wiki Maintainer**. Your job is to:
...
- Concept is unique to TwentyOne
- Pattern is TwentyOne-specific
- Decision only affects TwentyOne
