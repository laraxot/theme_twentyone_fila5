<div class="grid min-h-screen md:grid-cols-2">
    <div class="hidden bg-[#0F2734] p-16 text-white md:block">
        <div class="flex h-full flex-col justify-between">
            ...
            <div class="space-y-4">
                <p class="text-sm font-semibold uppercase tracking-[0.24em] text-slate-300">Nuovo account</p>
                <h1 class="text-[56px] font-semibold leading-tight">Crea il tuo account Predict</h1>
                <p class="max-w-md text-lg text-slate-300">
                    Registrati per partecipare ai mercati di previsione multi-esito e seguire i tuoi pronostici in tempo reale.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="relative bg-[#ECEFED]">
        <main class="container mx-auto max-w-md px-5 py-16">
            <div class="space-y-6">
                <h2 class="text-center text-3xl font-semibold text-slate-950">Crea il tuo account</h2>
                ...
                <form class="space-y-4" wire:submit.prevent="register">
                    <div class="space-y-1">
                        ...
                        <input wire:model.lazy="name" id="name" type="text" class="block h-14 w-full rounded-lg border border-slate-400 bg-transparent p-4 transition hover:border-slate-300 hover:bg-slate-300 focus:border-slate-400 focus:bg-transparent" placeholder="Il tuo nome" />
                        @error('name')
                    ...
                    <div class="space-y-1">
                        <label for="password_confirmation" class="block font-semibold">Conferma password</label>
                        <input wire:model.lazy="passwordConfirmation" id="password_confirmation" type="password" class="block h-14 w-full rounded-lg border border-slate-400 bg-transparent p-4 transition hover:border-slate-300 hover:bg-slate-300 focus:border-slate-400 focus:bg-transparent" />
                    </div>
                    ...
                    <button class="flex w-full items-center rounded-lg bg-[#0027cc] px-4 py-4 font-semibold text-white transition-colors duration-200 hover:bg-[#061989]">
                        <span class="grow text-center tracking-widest">Registrati</span>
                    </button>
                </form>
