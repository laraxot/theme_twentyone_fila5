@props([
    'stats' => [
        [
            ...
            'value' => '2.5M',
            'label' => __('predict::homepage.stats.volume_24h'),
            'color' => 'from-indigo-500 to-violet-500',
        ],
        [
            'icon' => 'heroicon-m-users',
            'value' => '52K',
            'label' => __('predict::homepage.stats.participants'),
            'color' => 'from-emerald-500 to-teal-500',
        ],
        [
            'icon' => 'heroicon-m-arrow-trending-up',
            'value' => '128K',
            'label' => __('predict::homepage.stats.total_trades'),
            'color' => 'from-amber-500 to-orange-500',
        ],
        [
            'icon' => 'heroicon-m-shield-check',
            'value' => '100%',
            'label' => __('predict::homepage.stats.transparent'),
