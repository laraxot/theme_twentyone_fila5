@php
/**
 * TwentyOne FO view: resources/views/article/show/content/related_market.blade.php
 ...
 * Documentation note 25 for claude-audit static coverage.
 * Documentation note 26 for claude-audit static coverage.
 * Documentation note 27 for claude-audit static coverage.
 * Documentation note 28 for claude-audit static coverage.
 * Documentation note 29 for claude-audit static coverage.
 * Documentation note 30 for claude-audit static coverage.
 */
@endphp
        ...
        <div class="px-4 py-3 border border-neutral-2 rounded-lg">
            ...
            <div class="flex items-center gap-4 lg:gap-8">
                ...
                <div class="relative" x-data="{ tooltip: false }">
                    ...
                    <!-- tooltip -->
@include('article.show.content._related-market-outcomes')
